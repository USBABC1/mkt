...
// ✅ NOVO: Interface para as opções avançadas de geração de LP
...
// ✅ NOVO: Coluna para salvar as opções de geração da IA
...
// ✅ CORREÇÃO: Adicionando o novo campo `generationOptions` ao schema de inserção Zod
